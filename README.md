# Midterm-Project
We have a Json file and 2 python files which takes the existing Json file as an input and gives out customer details like phone number and name, and also gives information about the menu items,price and number of orders we got. 
